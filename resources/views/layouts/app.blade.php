            ...
            <div class="row">
                <div class="col header p-3">
                    <header class="text-center">
                        <h1>
                            <p class="header-text"><a id="headerlink"
                                    href="{{ url('welcome') }}">{{ config('app.name', 'ToyShop') }}</a></p>
                        </h1>
                    </header>
                </div>

                <nav class="navbar navbar-expand-lg navbar-light bg-light m-10">
                    <a class="navbar-brand" href="{{ url('welcome') }}"><img src="/logo_small_icon_only.png" alt=""
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-center">
                            ...
                            <li class="nav-item dropdown"><a class="nav-link nav-button dropdown-toggle" href="#"
                            ...
                            <li class="nav-item"><a class="nav-link nav-button"
                                    href="{{ route('home.contact') }}">Contact</a></li>
                            <li class="nav-item"><a class="nav-link nav-button" href="{{ route('home.about') }}">About
                                    Us</a>
                            </li>
                ...
                <div class="row bg-transparent text-dark">
                    ...
                    <div class="col-md-3 col-sm-6 mt-4">
                        <div class="footer-info-single">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{ route('home.about') }}"></i> About Us</a></li>
                                <li><a href="#"></i> Test</a></li>
                                <li><a href="#"></i> Test</a></li>
                                <li><a href="{{ route('home.contact') }}"></i> Contact Us</a></li>
